...
public abstract class AbstractMyActivityGroup extends ActivityGroup implements android.widget.Button.OnClickListener{
	    ...
	    protected void setContainerView(String activityName, Class<?> activityClassTye){
	        ...
	        if (null == contentActivity||"contentActivity0".equals(activityName)||"contentActivity2".equals(activityName) ) {
