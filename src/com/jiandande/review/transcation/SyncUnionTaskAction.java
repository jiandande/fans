...
public class SyncUnionTaskAction extends AbstractTransaction {
	...
	public SyncUnionTaskAction() {
		url = ServerUrl.SyncUnionTask;//签到领积分	
	...
	protected ArrayList<NameValuePair> transPackage() {
		...
		NameValuePair namePair = new BasicNameValuePair(ParamName.EMAIL,
				sendData.email);
		params.add(namePair);
		NameValuePair passwordPair = new BasicNameValuePair(ParamName.UnionPOINT,
				sendData.syncmoney);
		params.add(passwordPair);
		NameValuePair imeiPair = new BasicNameValuePair(ParamName.USERID,
				sendData.imei);
		params.add(imeiPair);
		NameValuePair plattypePair = new BasicNameValuePair(ParamName.PLAYTYPE,
				sendData.plattype);
		params.add(plattypePair);
	...
	public void setPassword(String password) {
		sendData.syncmoney = password;
	}
	public void setPlatType(String plattype) {
		sendData.plattype = plattype;
	}
