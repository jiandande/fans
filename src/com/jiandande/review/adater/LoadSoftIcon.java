...
public class LoadSoftIcon {
    ...
    public LoadSoftIcon(Context context, String local_image_path) {
    ...
    public Bitmap loadImage(final ImageView imageView, final String imageUrl,
            final com.jiandande.review.adater.LoadUserAvatar.ImageDownloadedCallBack imageDownloadedCallBack) {
        ...
        if (imageUrl != null && !imageUrl.equals("")) {
            ...
            Thread thread = new Thread() {
                ...
                public void run() {
                    ...
                    options.inSampleSize = 1;//5; // width，hight设为原来的十分一 
